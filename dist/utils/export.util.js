...
class ExportUtils {
     ...
     */
    static appointmentsToCSV(appointments) {
     ...
     */
    static appointmentsToJSON(appointments) {
        if (!appointments || appointments.length === 0) {
            return '[]';
        }
     ...
     */
    static generateAppointmentSummary(appointments) {
        if (!appointments || appointments.length === 0) {
     ...
     */
    static dataToExcelXML(data, headers) {
