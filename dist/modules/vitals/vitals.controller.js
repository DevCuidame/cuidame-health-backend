...
class VitalsController {
     ...
     */
    createHeartRate = async (req, res, next) => {
        try {
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    updateHeartRate = async (req, res, next) => {
        try {
     ...
     */
    deleteHeartRate = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
     ...
     */
    getBloodPressuresByPatient = async (req, res, next) => {
        try {
            const patientId = parseInt(req.params.patientId);
            const userId = req.user?.id;
     ...
     */
    createBloodPressure = async (req, res, next) => {
        try {
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    updateBloodPressure = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    deleteBloodPressure = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
     ...
     */
    getBloodGlucosesByPatient = async (req, res, next) => {
        try {
            const patientId = parseInt(req.params.patientId);
            const userId = req.user?.id;
     ...
     */
    createBloodGlucose = async (req, res, next) => {
        try {
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    updateBloodGlucose = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    deleteBloodGlucose = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
     ...
     */
    getBloodOxygensByPatient = async (req, res, next) => {
        try {
            const patientId = parseInt(req.params.patientId);
            const userId = req.user?.id;
     ...
     */
    createBloodOxygen = async (req, res, next) => {
        try {
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    updateBloodOxygen = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    deleteBloodOxygen = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
     ...
     */
    getRespiratoryRatesByPatient = async (req, res, next) => {
        try {
            const patientId = parseInt(req.params.patientId);
            const userId = req.user?.id;
     ...
     */
    createRespiratoryRate = async (req, res, next) => {
        try {
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    updateRespiratoryRate = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
            const data = req.body;
     ...
     */
    deleteRespiratoryRate = async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
            const userId = req.user?.id;
