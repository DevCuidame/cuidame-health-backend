...
exports.ProfessionalStatsService = void 0;
...
class ProfessionalStatsService {
    ...
    async getProfessionalStats(professionalId, startDate, endDate) {
        ...
        const stats = {
            ...
            metrics: {
                ...
                busyDays: [], // Días con más citas
                patientDistribution: {}, // Distribución por paciente
                appointmentTypeDistribution: {} // Distribución por tipo de cita
            },
            timeSlots: {
     ...
     */
    async getProfessionalsRanking(startDate, endDate, limit = 10) {
        ...
        for (const professional of professionals) {
            ...
            appointments.forEach(appointment => {
                ...
                else if (appointment.status === appointment_model_1.AppointmentStatus.CANCELLED) {
                    cancelledCount++;
                }
            });
     ...
     */
    async getComparativeStats(startDate, endDate) {
        ...
        const stats = {
            ...
            topPerformers: {
                ...
                lowestCancellationRate: null,
                mostAppointments: null
            }
        };
        // Información temporal por especialidad para cálculos
        const specialtyTempData = {};
...
exports.ProfessionalStatsService = ProfessionalStatsService;
