...
async function testBatchVaccines() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/batch/vaccines`, data, { headers: { Authorization: `Bearer ${token}` } });
...
async function testBatchAllergies() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/batch/allergies`, data, { headers: { Authorization: `Bearer ${token}` } });
...
async function testBatchBackgrounds() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/batch/backgrounds`, data, { headers: { Authorization: `Bearer ${token}` } });
...
async function testBatchFamilyBackgrounds() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/batch/family-backgrounds`, data, { headers: { Authorization: `Bearer ${token}` } });
