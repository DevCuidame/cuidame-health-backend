...
async function testSyncVaccinesPhase1() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/sync/vaccines`, data, { headers: { Authorization: `Bearer ${token}` } });
...
async function testSyncAllergiesPhase1() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/sync/allergies`, data, { headers: { Authorization: `Bearer ${token}` } });
        console.log('Respuesta:', response.data);
        return true;
    }
    catch (error) {
...
async function testSyncBackgroundsPhase1() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/sync/backgrounds`, data, { headers: { Authorization: `Bearer ${token}` } });
        console.log('Respuesta:', response.data);
        return true;
    }
    catch (error) {
...
async function testSyncFamilyBackgroundsPhase1() {
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/medical-info/sync/family-backgrounds`, data, { headers: { Authorization: `Bearer ${token}` } });
        console.log('Respuesta:', response.data);
        return true;
    }
    catch (error) {
